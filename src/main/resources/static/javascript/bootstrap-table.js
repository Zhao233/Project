...
!function ($) {
    ...
    BootstrapTable.prototype.initServer = function (silent) {
        ...
        var pageable = "";
        pageable = "?offset=" + params.offset + "&limit=" + params.limit;
        if (params.search) pageable += "&q=" + params.search;

        $.ajax({
            type: this.options.method,
            url: this.options.url + pageable,
            data: data,
            ...
            success: function (res) {
                ...
                res = calculateObjectValue(that.options, that.options.responseHandler, [res.content], res.content);
                var data = res;
